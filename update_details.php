...
<head>
    ...
    <title>DHALLA AUTOMOTIVE PTY LTD | Update Details</title>
...
<body class="header-sticky" ng-app="UIS" ng-controller="homeCtrl"  ng-init="getUpdateDetailsById(<%=request.getParameter("updateid")%>)">
                    ...
                    <div class="row">
                        <div class="col-md-12">                    
                            <div class="page-title-heading">
                                <h1 class="title">{{getUpdateDetails.title}}</h1>
                                <p class="subtitle"></p>
                            ...
                            <div class="breadcrumbs">
                                ...
                                <ul>
                                    ...
                                    <li class="active">{{getUpdateDetails.title}}</li>
                                </ul>                   
                            </div><!-- /.breadcrumbs --> 
                        </div><!-- /.col-md-12 -->  
                    </div><!-- /.row -->  
                                ...
                                <div class="products-content-inner">
                                    <div class="single-products">
                                        ...
                                        <div class="single-img">
                                            <a class="popup-gallery" href="{{getUpdateDetails.image}}">
                                                <img src="{{getUpdateDetails.image}}" alt="images">
                                            </a>
                                        </div>

                                        <div class="summary">
                                            <h1 class="product_title">{{getUpdateDetails.title}}</h1>
                                            <div>
                                                <p class="price"><ins><span class="amount">{{getUpdateDetails.fromDate}} - {{getUpdateDetails.endDate}}</span></ins></p>
                                            </div>
                                            <div>
                                                <p class="price"><ins><span class="amount">{{getUpdateDetails.subtitle}}</span></ins></p>
                                            </div>
                                            <div class="descriptions">
                                                <p ng-bind-html="getUpdateDetails.description | to_trusted"></p>
                                            </div>
                                        </div>
                                    </div><!-- /.single-products -->
