                    ...
                    <div class="row">
                        <div class="col-md-12">                    
                            <div class="page-title-heading">
                                ...
                                <p class="subtitle">Repairing cars since 1986. Having fun and profit since 1988</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title-section">
                                <h2 class="title">Hello, We are AnyCar.</h2>
                                <p class="desc-title">We take care of everything — brakes, tires, oil changes — all your auto repair needs.</p>
                            </div>
                        </div><!-- /.col-md-12 -->
                    </div><!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="images-single style1">
                                        <div class="thumb">
                                            <a class="popup-gallery" href="<?php bloginfo('template_directory'); ?>/images/images-single/1.jpg">
                                                <img src="<?php bloginfo('template_directory'); ?>/images/images-single/1.jpg" alt="images">
                                            </a>
                                        </div>
                                    </div>
                                </div><!-- /.col-md-6 -->
                                <div class="col-md-6">
                                    <div class="images-single style1">
                                        <div class="thumb">
                                            <a class="popup-gallery" href="<?php bloginfo('template_directory'); ?>/images/images-single/2.jpg">
                                                <img src="<?php bloginfo('template_directory'); ?>/images/images-single/2.jpg" alt="images">
                                            </a>
                                        </div>
                                    </div>
                                </div><!-- /.col-md-6 -->
                                    ...
                                    <div class="content-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="images-single style1">
                                                    <div class="thumb">
                                                        <a class="popup-gallery" href="<?php bloginfo('template_directory'); ?>/images/about/1.jpg">
                                                            <img src="<?php bloginfo('template_directory'); ?>/images/about/1.jpg" alt="images">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div><!-- /.col-md-4 -->
                                    ...
                                    <div class="content-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="images-single style1">
                                                    <div class="thumb">
                                                        <a class="popup-gallery" href="<?php bloginfo('template_directory'); ?>/images/about/2.jpg">
                                                            <img src="<?php bloginfo('template_directory'); ?>/images/about/2.jpg" alt="images">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div><!-- /.col-md-4 -->
                                    ...
                                    <div class="content-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="images-single style1">
                                                    <div class="thumb">
                                                        <a class="popup-gallery" href="<?php bloginfo('template_directory'); ?>/images/about/3.jpg">
                                                            <img src="<?php bloginfo('template_directory'); ?>/images/about/3.jpg" alt="images">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div><!-- /.col-md-4 -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="counter">
                                <div class="counter-image">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/about/icon5.svg" alt="images">
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="counter">
                                <div class="counter-image">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/about/icon6.svg" alt="images">
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="counter">
                                <div class="counter-image">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/about/icon7.svg" alt="images">
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="counter">
                                <div class="counter-image">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/about/icon8.svg" alt="images">
                                </div>
