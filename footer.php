                                ...
                                <div class="footer-info">
                                    ...
                                    <div class="two-columns row">
                                        <div class="object">
                                            ...
                                            <strong>70A Cox Ave, Kingswood NSW 2747, Australia</strong> <br>
                                            <i class="fa fa-phone"></i>
                                            <strong>Tel:</strong> 0123 456 789
                                        </div>
                                        <div class="object ft-phone">
                                            <i class="fa fa-tablet"></i>
                                            <strong>Mobile: </strong>+61 2 4708 2717<br>
                                            <i class="fa fa-envelope"></i>
                                            <strong>E-mail:</strong>
                                            <a href="#">support@dhallaautomotive.com</a>
                                        </div>
                                    </div><!-- /.row -->
                                    <!-- <a href="#" class="button">
                        ...
                        <div class="col-md-12">
                            <div class="copyright">
                                ...
                                <div class="copyright-content">
                                    Copyright © 2021 DHALLA AUTOMOTIVE PTY LTD <!-- <a href="#">Themesflat.</a> -->    
...
<script type="text/javascript" src="<?php echo esc_url(get_template_directory_uri());?>/javascript/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo esc_url(get_template_directory_uri());?>/javascript/jquery.sticky.js"></script>
